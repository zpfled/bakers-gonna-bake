  ...
  describe 'set 1' do
    ...
    describe 'challenge 5' do
      it 'completed' do
        ...
        key = "ICE"
        encrypted_message = "0b3637272a2b2e63622c2e69692a23693a2a3c6324202d623d63343c2a26226324272765272\na282b2f20430a652e2c652a3124333a653e2b2027630c692b20283165286326302e27282f"
        expect(Crypto.challenge_5(message, key)[1]).to eq(encrypted_message)
      end
    end
  end
end